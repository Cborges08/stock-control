-- Migration 010: Fix fn_create_invoice — remove ncm from invoice_items INSERT
-- Bug found during validation: ncm is a products column, not invoice_items
-- invoice_items schema (migration 001) does not have ncm column
